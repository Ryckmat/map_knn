...
Original file is located at
    https://colab.research.google.com/drive/1Eo4Zbl2JOTsHZ618FjUMlliTR9y5pyqb
"""
...
kmeans.fit(X2[X2.columns[0:7]]) # Compute k-means clustering.
X2['cluster_label'] = kmeans.fit_predict(X2[X2.columns[0:7]])
centers = kmeans.cluster_centers_ # Coordinates of cluster centers.
labels = kmeans.predict(X2[X2.columns[0:7]]) # Labels of each point
